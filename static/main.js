...
const translations = {
  ...
  EN: {
    ...
    toScontent: "<p>This is an experiment that is available for a limited time, but not later than until 30 June 2023, and can be terminated at any time for any reasons, especially if too many requests use up too much of the money of the firm.</p><p>Do not use this chatbot for any real purposes, including for trying to get legal advice or legal services. Just use this chatbot to see why or why not this very popular model provided by OpenAI could be used for such purposes.</p><p>Any data you enter will be mandatorily shared with OpenAI due to technical reasons, the provider for the AI model used. Any data sent will be retained by OpenAI for abuse and misuse monitoring purposes for a maximum of 30 days, after which it will be deleted (unless otherwise required by law applicable to OpenAI). Such data sent to OpenAI will be stored in the United States of America, therefore please do not provide any personal data to this chatbot, because even if Homoki Ügyvédi Iroda (as a data controller) has a data processing agreement with OpenAI, that is not suitable for such data transfers, therefore we cannot legally transfer such data to the US.</p><p>Due to mandatory logging at the systems hosting the app, Homoki Ügyvédi Iroda will have access to the IP address of the visitor, the questions asked and the answers until next day UTC 0:01, but no other data (including the IP of the user asking the questions).</p><p>The web application conntecting to OpenAI is hosted at https://eu.pythonanywhere.com.</p><p>If you would like to submit any information (including complaints) to Homoki Ügyvédi Iroda in relation to your use of this chatbot, please send that to <a href=\"mailto:chatbot@homoki.net\">chatbot@homoki.net</a> However, due to the lack of resources, the small size of the firm and the free of charge, experimental nature of this service, Homoki Ügyvédi Iroda cannot promise that they will provide you any response at all, other than in cases where this is mandatory by law or by deontology rules applicable to lawyers in Hungary.</p><p>The source is available at <a href=\"https://github.com/Homoki-Ugyvedi-Iroda/chatbotdemo-lawfirm-2303\">GitHub</a>. This chatbot uses an AI, and for the limitations of the chatbot, see <a href=\"https://openai.com/blog/chatgpt#limitations\">OpenAI's</a> disclosure.</p>",
    }
};
